            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div
                            v-if="getffResults && getffResults.length > 0"
                            class="mt-3"
                        >
                            <div
                            ...
                            >
                                <h6 class="mb-0">
                                    Rezultatai ({{ getffResults.length }}):
                                </h6>
                                <button
                                    v-if="
                                        getffResults.length === getffForm.count
                                    "
                                    class="btn btn-sm btn-outline-info"
                                    @click="handleGetFFNextPage"
                                >
                        ...
                        <div
                            v-else-if="
                                getffResults && getffResults.length === 0
                            "
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div
                            v-if="getfbResults && getfbResults.length > 0"
                            class="mt-3"
                        >
                            <div
                                class="d-flex justify-content-between align-items-center mb-2"
                            >
                                <h6 class="mb-0">
                                    Rezultatai ({{ getfbResults.length }}):
                                </h6>
                                <button
                                    v-if="
                                        getfbResults.length === getfbForm.count
                                    "
                        ...
                        <div
                            v-else-if="
                                getfbResults && getfbResults.length === 0
                            "
                            class="mt-3 alert alert-info"
                        >
                            Nerasta įrašų.
...
>>>>>>> loggeris
    ...
    methods: {
        ...
        async handleDelete() {
            ...
            if (
                !confirm(`Ar tikrai norite ištrinti raktą "${this.deleteKey}"?`)
            ) {
                return;
            }
        ...
        async handleGetFF() {
            ...
            try {
                ...
                if (this.getffResults.length > 0) {
                    this.getffLastKey =
                        this.getffResults[this.getffResults.length - 1].key;
                }
        ...
        async handleGetFB() {
            ...
            try {
                ...
                if (this.getfbResults.length > 0) {
                    this.getfbLastKey =
                        this.getfbResults[this.getfbResults.length - 1].key;
                }
